...
export default defineConfig(({ command }) => ({
  ...
  ssr:
    command === "serve"
      ...
      : {
          // The production bundle runs in Workerd. Without this condition,
          // @openai/agents resolves its browser shim and disables tracing.
          resolve: {
            conditions: ["workerd", ...defaultClientConditions],
          },
        },
}));
